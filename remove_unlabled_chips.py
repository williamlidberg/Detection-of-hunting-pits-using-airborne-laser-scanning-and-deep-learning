...
def main(numpixels, label_path, image_path_1, image_path_2, image_path_3):
...
if __name__== '__main__':
    ...
    # parser.add_argument('image_path_4',default=None, help='outhput_path to copied image chips')
    # parser.add_argument('image_path_5',default=None, help='outhput_path to copied image chips')
    # parser.add_argument('image_path_6',default=None, help='outhput_path to copied image chips')
    # parser.add_argument('image_path_7',default=None, help='outhput_path to copied image chips')
    # parser.add_argument('image_path_8',default=None, help='outhput_path to copied image chips')
    # parser.add_argument('image_path_9',default=None, help='outhput_path to copied image chips')
    # parser.add_argument('image_path_10',default=None, help='outhput_path to copied image chips')
