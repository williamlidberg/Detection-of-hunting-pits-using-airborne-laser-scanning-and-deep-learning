...
launch container 
        ...
        docker run -it --gpus device=0:0 -v /mnt/Extension_100TB/William/GitHub/Detection-of-hunting-pits-using-airborne-laser-scanning-and-deep-learning:/workspace/code -v /mnt/Extension_100TB/William/Projects/Cultural_remains/data:/workspace/data -v /mnt/qnap1/william/data//:/workspace/lidar segmentation:latest bash

## Create DEMs from LAZ files

        time python /workspace/code/tools/laz_to_dem.py /workspace/lidar/laz/ /workspace/lidar/dem_05m/ 0.5
