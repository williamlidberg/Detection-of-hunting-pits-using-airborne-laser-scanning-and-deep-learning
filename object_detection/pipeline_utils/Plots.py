...
def plot_images(images, targets, paths=None, fname='images.jpg', names=None, max_size=640, max_subplots=16):
    ...
    for i, img in enumerate(images):
        ...
        if img.shape[2] == 2: # Manage 2 channel images
            mosaic[block_y:block_y + h, block_x:block_x + w, :2] = img
        elif img.shape[2] > 3: # Manage 3+ channel images
            mosaic[block_y:block_y + h, block_x:block_x + w, :] = img[:,:,:3]
        else: # Manage 3 and 1 channel images
