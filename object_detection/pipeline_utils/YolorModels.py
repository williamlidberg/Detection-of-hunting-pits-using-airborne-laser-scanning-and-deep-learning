...
def create_modules(module_defs, img_size, cfg):
    ...
    network_parameters = module_defs.pop(0)  # cfg training hyperparams (unused)
    output_filters = [network_parameters['channels']]  # input channels
    ...
    for i, mdef in enumerate(module_defs):
        ...
        if mdef['type'] == 'convolutional':
            ...
            yolo_index += 1
            stride = [8, 16, 32, 64, 128,256,512, 1024]  # P3, P4, P5, P6, P7 strides
