...
**Example**
python /workspace/code/semantic_segmentation/train_unet.py -I /workspace/data/final_data_05m/training/hillshade/ /workspace/data/final_data_05m/training/labels/ /workspace/data/logfiles/test/ --weighting="mfb" --seed=1 --depth=2 --epochs=200 --batch_size=4 --classes=0,1
...
-p 8888:8888 --mount type=bind,src=G:\moon\code,target=/workspace/code --mount type=bind,src=G:\moon\data,target=/workspace/data segmentation:latest
    ...
    python /workspace/code/semantic_segmentation/train_unet.py -I /workspace/data/lunar_data/final_data/training/maximal_curvature/ /workspace/data/lunar_data/final_data/training/labels/ /workspace/data/logfiles/moon/ --weighting="mfb" --seed=1 --depth=4 --epochs=100 --batch_size=64 --classes=0,1
