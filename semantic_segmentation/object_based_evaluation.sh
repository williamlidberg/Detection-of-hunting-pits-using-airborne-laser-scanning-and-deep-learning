...
# echo "stdon"
# python /workspace/code/semantic_segmentation/inference_unet.py -I /workspace/data/final_data_1m/testing/stdon/ /workspace/data/logfiles/UNet/1m/stdon1/trained.h5 /workspace/data/final_data_1m/testing/inference_UNet/1m/inference_raster/stdon/ UNet --classes 0,1 --tile_size 250
# python /workspace/code/semantic_segmentation/post_processing.py /workspace/temp/ /workspace/data/final_data_1m/testing/inference_UNet/1m/inference_raster/stdon/ /workspace/data/final_data_1m/testing/inference_UNet/1m/inference_polygon/stdon/ --output_type=polygon --min_area=30 --min_ratio=-1
