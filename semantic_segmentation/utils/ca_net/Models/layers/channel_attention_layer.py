...
class SE_Conv_Block(nn.Module):
    ...
    def __init__(self, inplanes, planes, shape, stride=1, downsample=None, drop_out=False):
        ...
        # define pooling kernel as same size as the input image shape
        self.globalAvgPool = nn.AvgPool2d(shape, stride=1)
        self.globalMaxPool = nn.MaxPool2d(shape, stride=1)
